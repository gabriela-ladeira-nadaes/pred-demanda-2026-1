...
def standardize(X_train: np.ndarray, X_test: np.ndarray) -> tuple[np.ndarray, np.ndarray, ColumnTransformer]:
    ...
    return X_train_processed, X_test_processed, standardizer
