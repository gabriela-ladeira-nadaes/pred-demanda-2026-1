...
from training.train import FinnancialModel, LinearRegression  # noqa: E402


class TestModelOutput(unittest.TestCase):
    def test_financial_model_output_shape(self):
        model = FinnancialModel(input_dim=10, output_dim=1)
    ...
    def test_financial_model_output_dim(self):
        model = FinnancialModel(input_dim=10, output_dim=3)
        out = model(torch.randn(8, 10))
